...
print("federated temperature: {}".format(get_average_temperature([68.5, 70.3, 69.8])))
...
def evaluate(server_state):
  ...
  loss, sparse_categorical_accuracy = keras_model.evaluate(central_emnist_test)
  return loss,sparse_categorical_accuracy
...
for round in range(NUM_ROUNDS):
  ...
  loss.append(evaluate(server_state)[0])
  sparse_categorical_accuracy.append(evaluate(server_state)[1])


import matplotlib.pyplot as plt
# ####-----------plot the loss & sparse_categorical_accuracy graph-------------####
# fig, axs = plt.subplots(1, 2)
# axs[0, 0].plot(np.arange(1,NUM_ROUNDS+1).tolist(), loss) #or axs[0, 0].plot(list(range(1,NUM_ROUNDS+1)), loss)
# axs[0, 0].set_title('Axis [0, 0]')
# axs[0, 1].plot(np.arange(1,NUM_ROUNDS+1).tolist(), sparse_categorical_accuracy, 'tab:orange')

fig, (ax1, ax2) = plt.subplots(1, 2)
fig.suptitle('Metrics')
ax1.plot(np.arange(1,NUM_ROUNDS+1).tolist(), loss) #or axs[0, 0].plot(list(range(1,NUM_ROUNDS+1)), loss)
ax1.set_title('loss')
ax2.plot(np.arange(1,NUM_ROUNDS+1).tolist(), sparse_categorical_accuracy, 'tab:orange')
ax2.set_title('sparse_categorical_accuracy')
plt.show()
